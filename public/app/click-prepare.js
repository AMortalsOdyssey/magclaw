async function prepareDocumentClick(event) {
  ...
  const localOnlyActions = new Set([
    ...
    'add-selected-text-channel-context',
    'copy-selected-message-text',
    'start-message-share',
    'toggle-share-selection',
    'toggle-share-select-all',
    'cancel-message-share',
    'copy-selected-markdown',
    'add-selected-messages-context',
    'download-selected-image',
    'close-share-preview',
    'save-share-image',
    'toggle-message-reaction',
    'jump-to-reference-source',
    'remove-composer-reference',
