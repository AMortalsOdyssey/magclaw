...
function renderRail() {
  ...
  const leftRailHtml = `
    <div class="magclaw-left-rail">
      ...
      ${renderLeftRailButton('share-root', railMode, 'Team Shares', '<path d="M3 7h7l2 2h9v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><path d="M3 7V5a2 2 0 0 1 2-2h4l2 2h3"/><path d="M8 13h8"/><path d="M8 17h5"/>')}
