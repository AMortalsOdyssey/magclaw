...
export function createOnboardingManager(deps) {
  ...
  function scheduleHumanOnboarding({ human, member = null, workspace = null, trigger = 'member_joined' } = {}) {
    ...
    const body = [
      ...
      'If useful, briefly mention the faster-start capabilities: Skill 说明 via the magclaw-team-sharing Skill for search/context/share links, Hooks 功能 for automatically syncing cleaned user text, final replies, plans, and interaction choices, and 数据查看 in the target MagClaw Channel.',
